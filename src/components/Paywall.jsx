            ...
            <>
              <div className="space-y-2">
                ...
                <button type="button" disabled
                        title="카카오 로그인은 사업자 인증 절차 후 활성화 예정"
                        className="w-full inline-flex items-center justify-center gap-2 rounded-xl px-4 py-3 font-semibold transition opacity-50 cursor-not-allowed"
                        style={{ background: '#FEE500', color: '#191600' }}>
                  <span className="text-base">💬</span>
                  카카오로 계속하기
                  <span className="text-[10px] font-normal opacity-70">(준비 중)</span>
                </button>
                <button type="button" disabled
                        title="네이버 로그인은 Custom Provider 설정 후 활성화 예정"
                        className="w-full inline-flex items-center justify-center gap-2 rounded-xl px-4 py-3 text-white font-semibold transition opacity-50 cursor-not-allowed"
              ...
              <p className="text-[10px] text-ink-500 dark:text-slate-500 text-center leading-relaxed">
                ⚠ 카카오·네이버는 인증 절차 후 활성화 예정. 지금은 Google 또는 익명 가입을 사용해 주세요.
              </p>
            </>
          )}
