    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <section className="card">
        ...
        <p className="section-subtitle">
          ...
          익명화된 코호트 데이터·연구 협력에 관심 있으시면 문의 폼으로 연락해 주세요.
        </p>
        <div className="mt-3 flex flex-wrap gap-2">
          <button onClick={() => navigate('contact')}
                  className="btn-primary !py-2 !px-4 text-sm">✉️ 연구·데이터 협력 문의</button>
          <a href="https://github.com/yhstella/wimalog/issues" target="_blank" rel="noopener noreferrer"
             className="btn-secondary !py-2 !px-4 text-sm">💬 GitHub Issues</a>
        </div>
      </section>
